defmodule Hello.Card do
  use Ecto.Schema
  import Ecto.Changeset
  import Ecto.Query

  alias Hello.{Repo, List, Card, Comment, CardMember}

  @derive {Jason.Encoder, only: [:id, :list_id, :name, :description, :position, :comments, :tags, :members]}
